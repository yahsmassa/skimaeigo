    ...
    qanda: [
      {
        ...
        isCorrect: false,
        points: 2,
        explanation: ['正解は② Australia － the US － the UK', '翻訳参照'],
      },
      {
        questionId: '2B-2',
        qa: [
    ...
    qanda: [
      {
        ...
        explanation: [
          ...
          '[32]・[33] 第4場の第4段落最終文 （それ以来，彼女は着実に出世し，今年，ボーテラの副社長に任命された）で，カスミが会社の副社長になったことが述べられている。さらに，第4場の最終段落で （「マキがいなかったら，私は今，副社長になってはいない」と彼女は思った。「私が悩んでいたときに彼女は助けてくれたのに，私はイシジマでの仕事に夢中で，彼女が予備校を辞めなければならなくなったときにサポートしてあげられなかった。」その記事をちらりと見返し。彼女はタクヤに電話することにした」とあるので，①「カスミが会社の副社長になる」の後に，②「カスミがタクヤに連絡する」が続くことになる。',
        ],
      },
      {
        questionId: '5-2',
  ...
  },
  {
    ...
    qanda: [
      ...
      },
      {
        ...
        points: 3,
        explanation: [
          '正解は③「不必要な物を避け、周りの人たちと質の高い時間を過ごし・・」とあるので',
          '④の「寝る前に欲しくないものは捨てる」は、「不必要な物を避ける」という内容とかぶっているが、③のほうがより適切',
        ],
      },
    ],
  },
