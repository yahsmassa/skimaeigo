    ...
    <div className={exPageFormat}>
      ...
      <div className="mt-8 space-y-8">
        <div>
          <div className="flex flex-wrap items-center mb-4 gap-2">
            <div className="flex items-center">
              <span className="font-serif mr-2 whitespace-nowrap">問 1</span>
              <span>What are you told to do after reading the handout?</span>
              <div className="border border-gray-800 px-3 py-1 whitespace-nowrap">
                1
              </div>
            </div>
          </div>
        ...
        <div>
          <div className="flex flex-wrap items-center mb-4 gap-2">
            <div className="flex items-center">
              <span className="font-serif mr-2 whitespace-nowrap">問 2</span>
