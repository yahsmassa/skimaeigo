        ...
        <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 md:py-12">
          <main className="prose prose-sm sm:prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                本アプリは、ユーザーに対してモバイルコンテンツおよび関連機能を提供します。サービス内容は予告なく変更される場合があります。アプリのアップデートにより機能が追加または変更されることがあります。
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-2">
                3.1
                本アプリの一部機能を利用するためには、アカウント登録が必要です。
              </p>
              <p className="text-gray-700 mb-2">
                3.2
