          ...
          <main className="prose prose-sm sm:prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                本プライバシーポリシーは、当社が提供するiPhone・iPadおよびAndroid向けアプリケーション（以下「本アプリ」といいます）における、ユーザーの個人情報の取り扱いについて定めるものです。当社は、ユーザーのプライバシーを尊重し、適用される法令に従って個人情報を保護することをお約束します。本アプリを利用することにより、ユーザーは本プライバシーポリシーに同意したものとみなされます。
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="ml-0 sm:ml-4 mb-4">
                ...
                <ul className="list-disc ml-5 text-gray-700 space-y-1">
                  ...
                  <li>
                    支払い情報（Apple App StoreまたはGoogle Play経由での支払い）
                  </li>
              ...
              <div className="ml-0 sm:ml-4 mb-4">
                ...
                <ul className="list-disc ml-5 text-gray-700 space-y-1">
                  <li>デバイス情報（デバイスの種類、OSバージョン）</li>
                  <li>アプリ識別子</li>
                  <li>IPアドレス</li>
                  <li>アプリケーションの使用状況とパフォーマンスデータ</li>
                  <li>モバイル広告識別子（IDFA、GAID）</li>
                </ul>
              </div>
              ...
              <div className="ml-0 sm:ml-4 mb-4">
                ...
                <ul className="list-disc ml-5 text-gray-700 space-y-1">
                  ...
                  <li>RevenueCat経由で取得する支払い処理・サブスクリプション管理情報</li>
                  <li>Apple App StoreおよびGoogle Playから提供される取引情報</li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc ml-5 text-gray-700 space-y-1">
                ...
                <li>カスタマーサポートの提供</li>
                <li>ユーザー認証と本人確認</li>
                <li>RevenueCatを通じた支払い処理と課金管理</li>
            ...
            <section className="mb-8">
              ...
              <div className="ml-0 sm:ml-4 mb-3">
                ...
                <ul className="list-disc ml-5 text-gray-700 space-y-1">
                  <li>Apple App StoreおよびGoogle Play</li>
                  <li>RevenueCat（サブスクリプション管理サービス）</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                本アプリは、特定の機能を提供するために、以下のようなデバイス権限を要求することがあります：
              </p>
              <ul className="list-disc ml-5 text-gray-700 space-y-1">
                <li>カメラ（プロフィール画像のアップロードなど）</li>
                <li>写真ライブラリ（画像のアップロードなど）</li>
                <li>通知（アップデートや重要なお知らせなど）</li>
              </ul>
              <p className="text-gray-700 mt-2">
                これらの権限はいつでもデバイスの設定から変更することができます。
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                本アプリは13歳未満の子どもを対象としていません。当社は、13歳未満の子どもから意図的に個人情報を収集することはありません。13歳未満の子どもの個人情報を収集したことが判明した場合、速やかに当該情報を削除します。
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                当社は、本プライバシーポリシーを随時更新することがあります。重要な変更がある場合は、本アプリ内での通知または登録されたメールアドレスへの連絡により、ユーザーに通知します。最新のプライバシーポリシーは常に本アプリ内で確認できます。
              </p>
            </section>
